...
![Phân tích lưu trữ](docs/screenshots/02_phan_tich.png)
...
![Dọn dẹp hệ thống](docs/screenshots/03_don_dep.png)
...
![Gỡ cài đặt phần mềm](docs/screenshots/04_go_phan_mem.png)
...
![Tìm file trùng lặp](docs/screenshots/05_tim_file.png)
...
![Quyền riêng tư](docs/screenshots/06_quyen_rieng_tu.png)
...
![Junction Link](docs/screenshots/07_junction.png)
...
![Khởi động Windows](docs/screenshots/08_khoi_dong.png)
...
![Diệt virus](docs/screenshots/09_diet_virus.png)
...
![Tối ưu hệ thống](docs/screenshots/10_toi_uu.png)
...
![Kiểm tra hệ thống](docs/screenshots/11_kiem_tra.png)
...
![License & Activation](docs/screenshots/12_license.png)
